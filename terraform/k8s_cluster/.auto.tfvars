...
kubernetes_clusters_project = {
    ...
    enable_boot_disk_snapshot_attach   = false
  ...
  "us-south1-c"
    ...
    instance_image_selflink            = "projects/rhel-cloud/global/images/rhel-9-4-eus-v20260310"
  ...
  "10.0.0.18"
    ...
    network_tags                       = ["yugabyte","allow-ssh","k8s","allow-all"]
